...
def main():
    ...
    mlflow.set_experiment(os.getenv("EXPERIMENT_NAME", "mushroom-classification"))

    optimize_logistic(X_train, y_train, X_val, y_val, num_trials)
    optimize_xgboost(X_train, y_train, X_val, y_val, num_trials)
